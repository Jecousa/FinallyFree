...
export const TAGLINES: Tagline[] = [
    ...
    {
        id: 'Services', mainText: 'Customized Software Solutions', tag: 'Learn About Our Services', image: '.././../assets/backgrounds/DSC_0007.JPG'
    },
    {
        id: 'Blog', mainText: 'Tutorials, News, and Entertainment', tag: '', image: '.././../assets/backgrounds/DSC_0137.JPG'
    }
];
